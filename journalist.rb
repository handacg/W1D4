...
puts list_journalist.count
# => return 379


puts list_journalist.grep(/[1-9]/).count
# => return 17


puts list_journalist.grep(/(aude)/i).count
# => @AudeDavidRossi  @TGiraudet  @MaudeML
# => return 3
# "i" means insensible to case


puts list_journalist.count {|c| c =~ /@[A-Z]/}
# => return 209 
# => =~  If a match is found, the operator returns index of first match in string, otherwise it returns nil
# => here, we are looking to match the first CAPITAL LETTER after "@"
